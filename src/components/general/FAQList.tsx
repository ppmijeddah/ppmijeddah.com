...
const FAQList = () => {
  const [questionsAnswers, setQuestionsAnswers] = useState(getInitialFAQs());
...
status kelulusannya menjadi Qabul Nihai yang ditandai dengan terbitnya Calling Visa dan ‘Isyar Qabul.`,
    ...
    {
      question:
        "Apakah jika ingin mendaftar UIM harus melalui Study in Saudi ?",
...
alamat dan kontak, data media sosial.`,
  ...
  return initialQuestionsAnswers;
};
